...
from CementStrength.components import DataIngestion,DataValidation,DataTransformation,ModelEvaluation,ModelPusher,ModelTrainer
from CementStrength.config import Configuration
from CementStrength.constants import EXPERIMENT_DIR_NAME, EXPERIMENT_FILE_NAME
from CementStrength import logger
from CementStrength.entity import DataIngestionConfig, ModelTrainerConfig,DataIngestionArtifact, DataTransformationArtifact, DataValidationArtifact, ModelEvaluationArtifact, ModelTrainerArtifact
import os, sys
...
class Pipeline(Thread):
    ...
    def run_pipeline(self):
        try:
            ...
            logger.info(f"Pipeline experiment: {Pipeline.experiment}")
            ...
            if model_evaluation_artifact.is_model_accepted:
                ...
                logger.info("Trained model rejected.")
